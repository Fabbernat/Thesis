...
def makeSentenceHumanReadable(sentence: str, version: str = 'new') -> str:
    if version == 'old':
        return makeSentenceHumanReadableOld(sentence)
    else:
        return makeSentenceHumanReadableNew(sentence)



def makeSentenceHumanReadableOld(sentence: str) -> str:
    """
...
def makeSentenceHumanReadableNew(sentence: str) -> str:
    """
