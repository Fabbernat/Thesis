...
# Create TF-IDF vectorizer with both unigrams and bigrams
...
# Function to predict year for new text
...
# Example usage
test_text = """A train robbery occurs in the mountains..."""
predicted_year = predict_year(test_text)
print(f"\nPredicted year for test text: {predicted_year}")