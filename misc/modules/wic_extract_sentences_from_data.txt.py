# C:\PycharmProjects\Peternity\modules_and_data\modules\wic_extract_sentences_from_data.text_files.py
...
file_path = f'../data/text_files/{actual_working_dataset}.data.txt'
...
with open(f'../data/text_files/{actual_working_dataset}_extracted_sentences.txt', 'w', encoding='utf-8') as outfile:
