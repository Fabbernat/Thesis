# C:\PycharmProjects\Peternity\modules_and_data\rank_bm25.py
#!/usr/bin/env python
...
from misc.modules import wic_word_sense_disambiguator
...
class BM25Okapi(BM25):
    ...
    def _calc_idf(self, nd):
        ...
        # idf can be negative if the word is contained in more than half of documents
        negative_idfs = []
