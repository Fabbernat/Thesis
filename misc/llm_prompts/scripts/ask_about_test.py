...
human_readable_questions_short: Dict[str, str] = {
    ...
    'Does the word "response" mean the same thing in sentences "His response to any problem was to get drunk." and "Their response was to sue me."?': 'Yes',
    ...
    'Does the word "response" mean the same thing in sentences "There is no simple response to corruption." and "The answers were in the back of the book."?': 'Yes',
    ...
    'Does the word "knitting" mean the same thing in sentences "She put down her knitting and went to response the phone." and "I find knitting very relaxing."?': 'No',
