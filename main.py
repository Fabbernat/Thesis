# combines the dataset and evaluates them using tfidf or bert
# C:\PycharmProjects\Peternity\app
...
def main():
    ...
    data_file = os.path.normpath('WiC_dataset' + rf'\{actual_working_dataset}\{actual_working_dataset}.data.txt')
    gold_file = os.path.normpath('WiC_dataset' + rf'\{actual_working_dataset}\{actual_working_dataset}.gold.txt')
