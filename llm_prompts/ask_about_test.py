...
'Does the word "morale" mean the same thing in sentences "Morale is an important quality in soldiers. With good morale they\'ll charge into a hail of bullets ; without it they won\'t even cross a street." and "After the layoffs morale was at an all time low, they were so dispirited nothing was getting done."?':'Yes',
...
'Does the word "fire" mean the same thing in sentences "Don\'t fire until you see the whites of their eyes." and "The gun fired."?':'Yes',
...
'Does the word "snorter" mean the same thing in sentences "The storm wasnot long but it was a snorter." and "A snorter of a sermon."?':'Yes',
...
'Does the word "sex" mean the same thing in sentences "She didnot want to know the sex of the foetus." and "Slime molds are sometimes erroneously said to have thirteen sexes."?':'Yes',
...
'Does the word "relish" mean the same thing in sentences "I don\'t relish the idea of going out tonight." and "He relishes their time together."?':'Yes',
...
'Does the word "captain" mean the same thing in sentences "A captain of industry." and "John Henry said to the captain, " A man ainot nothing but a man. "."?':'Yes',
...
'Does the word "jump" mean the same thing in sentences "The parachutist didnot want to jump." and "Every year, hundreds of people jump off the Golden Gate bridge."?':'Yes',
...
'Does the word "account" mean the same thing in sentences "Don\'t do it on my account." and "The paper was rejected on account of its length."?':'Yes',
...
'Does the word "heating" mean the same thing in sentences "They have radiant heating." and "The heating system wasnot working."?':'Yes',
...
'Does the word "map" mean the same thing in sentences "We havenot even begun to map the many galaxies that we know exist." and "Sorrow was mapped on the mother\'s face."?': 'No',
...
'Does the word "leg" mean the same thing in sentences "After six days, we\'re finally in the last leg of our cross-country trip." and "Dan won\'t be able to come to the party, since he broke his leg last week and is now on crutches."?': 'No',
...
'Does the word "begin" mean the same thing in sentences "You can not even begin to understand the problem we had to deal with during the war." and "This economic measure doesnot even begin to deal with the problem of inflation."?':'Yes',
...
'Does the word "sleep" mean the same thing in sentences "We need to conduct an overnight sleep test to diagnose your sleep problem." and "He didnot get enough sleep last night."?':'Yes',
...
'Does the word "top" mean the same thing in sentences "I don\'t want to be bald, so just top my hair." and "Top trees and bushes."?':'Yes',
...
'Does the word "truth" mean the same thing in sentences "He thought of answering with the truth but he knew they wouldnot believe it." and "Hunger and jealousy are just eternal truths of human existence."?':'Yes',
...
'Does the word "match" mean the same thing in sentences "Their interests didnot match, so it took a long time to agree what to do together." and "These two copies are supposed to be identical, but they don\'t match."?':'Yes',
...
'Does the word "manage" mean the same thing in sentences "The young violinist didnot manage her bow very well." and "She managed her parents ` affairs after they got too old."?': 'No',
...
'Does the word "age" mean the same thing in sentences "Age hasnot slowed him down at all." and "Old age is not for sissies."?':'Yes',
...
'Does the word "shake" mean the same thing in sentences "Don\'t shake your fist at me !" and "These stories shook the community."?': 'No',
...
'Does the word "card" mean the same thing in sentences "They have to card anybody who looks 21 or younger." and "I heard you don\'t get carded at the other liquor store."?':'Yes',
...
'Does the word "do" mean the same thing in sentences "What makes her do this way ?" and "Don\'t behave like a fool."?':'Yes',
...
'Does the word "thing" mean the same thing in sentences "I couldnot tell what the thing was." and "Things are going well."?': 'No',
...
'Does the word "stimulate" mean the same thing in sentences "This herbal infusion doesnot stimulate." and "Coffee and tea stimulate me."?':'Yes',
...
'Does the word "snapshot" mean the same thing in sentences "He carried a snapshot of his daughter." and "My snapshots havenot been developed yet."?':'Yes',
...
'Does the word "sober" mean the same thing in sentences "She\'s in no state to go home by herself, so make sure she doesnot drink anything else, and she\'ll soon sober up." and "Keep him in bed until he sobers up."?':'Yes',
...
'Does the word "generate" mean the same thing in sentences "We can\'t generate enough power for the entire city." and "The hydroelectric plant needs to generate more electricity."?':'Yes',
...
'Does the word "discourage" mean the same thing in sentences "We should discourage this practice among our youth." and "Don\'t be discouraged by the amount of work left to do : you\'ll finish it in good time."?': 'No',
...
'Does the word "elaborate" mean the same thing in sentences "What do you mean you didnot come home last night ? Would you care to elaborate ?" and "She elaborated on the main ideas in her dissertation."?': 'No',
...
'Does the word "responsibility" mean the same thing in sentences "Every right implies a responsibility." and "Why didnot you clean the house ? That was your responsibility !"?':'Yes',
...
'Does the word "delay" mean the same thing in sentences "Don\'t delay your application to graduate school or else it won\'t be considered." and "He delayed the watering."?':'Yes',
...
'Does the word "state" mean the same thing in sentences "He was in such a state you just couldnot reason with him." and "Though legally single nations, many states comprise several distinct cultural or ethnic groups."?': 'No',
...
'Does the word "cook" mean the same thing in sentences "My husband doesnot cook." and "The apothecary cooked the medicinal mixture in a big iron kettle."?': 'No',
'Does the word "toast" mean the same thing in sentences "Let us toast the birthday girl !" and "Toast bread."?': 'No',
'Does the word "writing" mean the same thing in sentences "He turned the paper over so the writing wouldnot show." and "The doctor\'s writing was illegible."?':'Yes',
...
'Does the word "scram" mean the same thing in sentences "If you don\'t scram, I\'ll leave instead !" and "Scram !"?':'Yes',
...
'Does the word "program" mean the same thing in sentences "Working mothers rely on the day care program." and "You can\'t tell the players without a program."?': 'No',
...
'Does the word "half" mean the same thing in sentences "Half an hour." and "You don\'t know the half of it."?':'Yes',
...
'Does the word "recognition" mean the same thing in sentences "He looked at her for ten full minutes before recognition dawned." and "He was unable to make his motion because he couldnot get recognition by the chairman."?': 'No',
...
'Does the word "overreact" mean the same thing in sentences "Please try not to overreact if she drives badly when she is first learning." and "Don\'t overreact to the bad news -- take it easy."?':'Yes',
...
'Does the word "drink" mean the same thing in sentences "You can lead a horse to water but you can\'t make him drink." and "Cynthia drank the wine."?':'Yes',
...
'Does the word "fit" mean the same thing in sentences "This piece won\'t fit into the puzzle." and "I wanted to borrow my little sister\'s jeans, but they didnot fit."?':'Yes',
...
'Does the word "digress" mean the same thing in sentences "Don\'t digress when you give a lecture." and "She always digresses when telling a story."?':'Yes',
...
'Does the word "train" mean the same thing in sentences "Train of mourners." and "Express trains don\'t stop at Princeton Junction."?': 'No',
...
'Does the word "account" mean the same thing in sentences "Passing grades account for half of the grades given in this exam." and "I can\'t account for the missing money."?': 'No',
...
'Does the word "flip" mean the same thing in sentences "I don\'t know what to do -- I may as well flip a coin !" and "Flip me the beachball."?': 'No',
...
'Does the word "suggestion" mean the same thing in sentences "It was a suggestion we couldnot refuse." and "Suggestion often works better than explicit demand."?': 'No',
...
'Does the word "figure" mean the same thing in sentences "He didnot figure her." and "I can\'t figure if he\'s telling the truth or lying."?':'Yes',
...
'Does the word "complaint" mean the same thing in sentences "Don\'t come too close, I\'ve got this nasty complaint." and "I have no complaints about the quality of his work, but I don\'t enjoy his company."?': 'No',
...
'Does the word "look" mean the same thing in sentences "Don\'t look in the closet." and "Look at my new car !"?':'Yes',
...
'Does the word "mind" mean the same thing in sentences "I wouldnot mind an ice cream right now." and "I don\'t mind your behavior."?':'Yes',
...
'Does the word "freeze" mean the same thing in sentences "Don\'t go outside wearing just a t-shirt ; you\'ll freeze !" and "It\'s freezing in here !"?':'Yes',
...
'Does the word "agree" mean the same thing in sentences "I can\'t agree with you !" and "They agreed about what should be done."?':'Yes',
...
'Does the word "segregate" mean the same thing in sentences "We don\'t segregate in this county." and "This neighborhood is segregated."?':'Yes',
...
'Does the word "hack" mean the same thing in sentences "I can\'t hack it anymore." and "He hacked his way through the forest."?': 'No',
...
'Does the word "count" mean the same thing in sentences "Your views don\'t count here." and "Count your change."?': 'No',
...
'Does the word "intrude" mean the same thing in sentences "The colors don\'t intrude on the viewer." and "They intruded on our dinner party."?': 'No',
...
'Does the word "stoop" mean the same thing in sentences "I won\'t stoop to reading other people\'s mail." and "He stooped to tie his shoe-laces."?': 'No',
...
'Does the word "sign" mean the same thing in sentences "Don\'t forget the minus sign." and "It was a sign from God."?': 'No',
...
'Does the word "shuffle" mean the same thing in sentences "Don\'t forget to shuffle the cards." and "The data packets are shuffled before transmission."?':'Yes',
