...
human_readable_questions_short: Dict[str, str] = {
    ...
    'Does the word "push" mean the same thing in sentences "Some details got lost in the push to get the project done." and "The army made a push toward the sea."?': 'No',
    'Does the word "bake" mean the same thing in sentences "Idaho potatoes bake beautifully." and "This oven bakes potatoes."?': 'Yes',
    'Does the word "relieve" mean the same thing in sentences "Relieve the pressure and the stress." and "This pill will relieve your headaches."?': 'Yes',
    ...
    'Does the word "crumb" mean the same thing in sentences "Crumb the table." and "Crumb a cutlet."?': 'Yes',
    'Does the word "include" mean the same thing in sentences "I include you in the list of culprits." and "The list includes the names of many famous writers."?': 'Yes',
    'Does the word "companion" mean the same thing in sentences "His dog has been his trusted companion for the last five years." and "Drinking companions."?': 'No',
    ...
    'Does the word "cure" mean the same thing in sentences "Cure meats." and "Cure hay"?': 'Unknown',
    'Does the word "rift" mean the same thing in sentences "My marriage is in trouble, the fight created a rift between us and we can\'t reconnect." and "The Grand Canyon is a rift in the Earth\'s surface, but is smaller than some of the undersea ones."?': 'Unknown',
    'Does the word "swim" mean the same thing in sentences "We had to swim for 20 minutes to reach the shore." and "A big fish was swimming in the tank."?': 'Unknown',
    'Does the word "quiet" mean the same thing in sentences "The library was so quiet you could hear a pin drop." and "She tried to quiet the crying baby."?': 'Unknown',
    'Does the word "top" mean the same thing in sentences "She reached the top of the mountain." and "He spun the wooden top on the table."?': 'Unknown',
    'Does the word "consultation" mean the same thing in sentences "A consultation of several medical specialists." and "Frequent consultations with his lawyer."?': 'Unknown',
    ...
    'Does the word "rag" mean the same thing in sentences "Rag that old tune." and "Rag ore."?': 'Unknown',
    'Does the word "work" mean the same thing in sentences "Work equals force times distance." and "Work is done against friction to drag a bag along the ground."?': 'Unknown',
    ...
    'Does the word "virus" mean the same thing in sentences "The virus of jealousy is latent in everyone." and "He caught a virus and had to stay home from school."?': 'Unknown',
    'Does the word "humour" mean the same thing in sentences "The sensitive subject was treated with humour, but in such way that no one was offended." and "She has a great sense of humour, and I always laugh a lot whenever we get together."?': 'Unknown',
    'Does the word "neighbor" mean the same thing in sentences "What is the closest neighbor to the Earth?" and "Fort Worth is a neighbor of Dallas."?': 'Unknown',
    'Does the word "sinking" mean the same thing in sentences "He could not control the sinking of his legs." and "After several hours of sinking an unexpected rally rescued the market."?': 'Unknown',
    'Does the word "sneak" mean the same thing in sentences "Sneak a look." and "Sneak a cigarette."?': 'Unknown',
    'Does the word "fix" mean the same thing in sentences "Fix your eyes on this spot." and "Fix a race."?': 'Unknown',
    'Does the word "impulse" mean the same thing in sentences "The impulse knocked him over." and "The total impulse from the impact will depend on the kinetic energy of the bullet."?': 'Unknown',
    'Does the word "fetish" mean the same thing in sentences "I know a guy who has a foot fetish." and "Common male fetishes are breasts , legs , hair , shoes , and underwear."?': 'Unknown',
    'Does the word "seizure" mean the same thing in sentences "The seizure of a thief , a property , a throne , etc ." and "The search warrant permitted the seizure of evidence ."?': 'Unknown',
    'Does the word "pattern" mean the same thing in sentences "The American constitution has provided a pattern for many republics ." and "They changed their dietary pattern ."?': 'Unknown',
    'Does the word "conscience" mean the same thing in sentences "A person of unflagging conscience ." and "He has no conscience about his cruelty ."?': 'Unknown',
    'Does the word "demistify" mean the same thing in sentences "The article was written to demystify the mechanics of the internal combustion engine ." and "Let\'s demystify the event by explaining what it is all about ."?': 'Unknown',
    'Does the word "team" mean the same thing in sentences "We need more volunteers for the netball team." and "The IT manager leads a team of three software developers."?': 'Unknown',
    'Does the word "conduct" mean the same thing in sentences "You can not conduct business like this." and "To conduct the affairs of a kingdom."?': 'Unknown',
...
unchecked_questions = {
    ...
    'Does the word "talking" mean the same thing in sentences "We spent hours talking about our future." and "The parrot was talking in a human-like voice."?': 'Unknown',
    'Does the word "school" mean the same thing in sentences "She goes to school every weekday." and "A school of fish swam past the boat."?': 'Unknown',
'Does the word "lawyer" mean the same thing in sentences "She hired a lawyer to represent her in court." and "He was his own lawyer in the trial."?': 'Unknown',
