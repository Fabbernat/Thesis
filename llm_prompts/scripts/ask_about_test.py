...
human_readable_questions_short: Dict[str, str] = {
    ...
    'Does the word "Resurrection" mean the same thing in sentences "The Resurrection of flowers created a pleasing effect." and "The Resurrection of five more items to the agenda will make the meeting unbearably long."?': 'Yes',
